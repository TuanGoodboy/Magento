 ...
 */
namespace Custommodule\Design\Ui\Component\Listing\Grid\Column;
...
{
    /** Url path */
    const ROW_EDIT_URL = 'design/grid/addrow';
    /** @var UrlInterface */
