...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Custommodule_Design::designer_list');
        $resultPage->getConfig()->getTitle()->prepend(__('Designer List'));
        return $resultPage;
    }
    ...
    {
        return $this->_authorization->isAllowed('Custommodule_Design::designer_list');
    }
}
